...
public class JavaMongoDbDemo {
	...
	public static void main(String[] args) {
		try {
			...
			String uri = "mongodb://fatay96:fatay123@ds113375.mlab.com:13375/thread";
			MongoClientURI clientURI = new MongoClientURI(uri);
			MongoClient mongoClntObj  = new MongoClient(clientURI);
			DB dbObj  = mongoClntObj .getDB("thread");
			DBCollection collectionObj =  dbObj.getCollection("threadname");
